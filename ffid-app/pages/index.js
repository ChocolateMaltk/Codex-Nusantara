...
const Home = () => {
  return (
    <div>
      <header className="bg-darkFlora py-4">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <a href="#" className="bg-sky-300	 text-white px-4 py-2 mt-4 inline-block rounded hover:bg-blue-600">
          Get Started
        </a>
      </main>

      <footer className="bg-darkFlora py-4 text-center text-white">
