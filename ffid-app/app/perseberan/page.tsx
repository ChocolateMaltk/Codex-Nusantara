    ...
    <div className="mt-6 mb-6 flex flex-col items-center">
      ...
      <div className="grid m-2 p-2 grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <div className="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
          ...
          <p className="h-32 w-64 text-gray-600 mb-4 text-center">
            Flora dan Fauna Asiatis adalah mereka yang memiliki kemiripan atau
            saudara di Benua Asia. Flora dan Fauna ini bisa ditemukan di Pulau
            Sumatera, Jawa dan Kalimantan.
          </p>
          <div className="flex justify-center mt-2">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              <Link href={"/perseberan/asiatis"}>Read More</Link>
            </button>
          </div>
        </div>
        <div className="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
          ...
          <p className="h-32 w-64 text-gray-600 mb-4 text-center">
            Flora dan Fauna Indonesia Tengah adalah Flora dan Fauna yang khusus
            ditemukan di Indonesia Bagian Tengah seperti di Pulau Sulawesi,
            Kepulauan Nusa Tenggara dan sekitarnya.
          </p>
          <div className="flex justify-center mt-2">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              <Link href={"/perseberan/indonesia-tengah"}>Read More</Link>
            </button>
          </div>
        </div>
        <div className="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
          ...
          <p className="h-32 w-64 text-gray-600 mb-4 text-center">
            Flora dan Fauna Australis adalah Flora dan Faunya yang khusus
            ditemukan di Indonesia Bagian Timur seperti di Kepulauan Maluku,
            Pulau Papua dan sekitarnya.
          </p>
          <div className="flex justify-center mt-2">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              <Link href={"/perseberan/australis"}>Read More</Link>
            </button>
          </div>
        </div>
      </div>
